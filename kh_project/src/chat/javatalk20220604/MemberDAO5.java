...
public class MemberDAO5 {
	...
	public MemberDAO5() {
		...
		//System.out.println(SignIn("tomato453", "456", "mamato"));
		System.out.println(SignIn("tomato789", "456", "mato"));
	}
	
	// 회원가입 메소드
	private MemberVO SignIn(String mem_id, String mem_pw, String mem_nick) {
